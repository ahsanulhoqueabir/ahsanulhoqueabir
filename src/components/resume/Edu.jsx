    ...
    <section className="my-8">
      ...
      <div className="time-line-area flex flex-col gap-8">
        <div className="text-[15px] flex flex-col gap-1">
          <h3 className=" font-bold ">Jagannath University</h3>
          <h3 className=" text-primary mt-1">June, 2023 - present</h3>
          <p>Department of Computer Science & Engineering.</p>
        </div>
        <div className="text-[15px] flex flex-col gap-1">
          <h3 className=" font-bold ">Hazera-Taju University College</h3>
